package com.emilio.orders.dao.direct;
...
/**
 * Implementación de ZonaEnvioDAO que utiliza directamente la API de Hibernate.
 */
public class DirectZonaEnvioDAO implements ZonaEnvioDAO {
    private static final Logger logger = LoggerFactory.getLogger(DirectZonaEnvioDAO.class);
    private final SessionManager sessionManager;

    /**
     * Constructor que inicializa el DAO.
     */
    public DirectZonaEnvioDAO() {
        this.sessionManager = SessionManager.getInstance();
        logger.debug("DirectZonaEnvioDAO inicializado");
    }
