...
/**
 * Implementación de ClienteDAO que utiliza directamente la API de Hibernate.
 */
public class DirectClienteDAO implements ClienteDAO {
    private static final Logger logger = LoggerFactory.getLogger(DirectClienteDAO.class);
    ...
    public DirectClienteDAO() {
        ...
        logger.debug("DirectClienteDAO inicializado");
    }
